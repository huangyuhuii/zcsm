    ...
    $(".nojavascript").remove(), setInterval(function () {
        ...
        $(".write-ok").fadeIn(), $("#text-href").focus(), $("#back").click(function () {
            ...
            "" == b.replace(/\s+/g, "") ? ($("#write-url i").text("\u2190\u4e0d\u80fd\u4e3a\u7a7a").fadeIn(), $("#text-href").focus(), setTimeout(function () {
                ...
                $("#write-mp3 i").fadeOut()
            }, 3e3)) : /^(http|https):\/\/+([\w-]+\.)+[\w-]+(\/[\w-.\/?%&=]*)?$/.test(c) ? ($("#back").html('<img src="/static/special/img/loading.gif" alt="loading">'), $("#write-post").text("\u9875\u9762\u751f\u6210\u4e2d...").attr("disabled", !0).addClass("disabled"), $.post("love.php?add", {
                textHref: b,
                textMusic: c,
                textArr: a
            }, function (a) {
